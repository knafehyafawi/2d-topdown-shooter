...
func spawn_enemy() -> void:
	print("spawn_enemy called. enemy_scenesL ", enemy_scenes.size(), " | Spawn points: ", spawn_points.size())
	if enemy_scenes.is_empty() or spawn_points.is_empty():
		print("No spawn. One of the arrays is empty.")
		return
	...
	print("Valid points after filtering: ", valid_points.size(), " (out of ", spawn_points.size(), " total)")
	...
	print("Enemy spawn at: ", spawn_point)
